...
cd /var/www/project/labiomed/docroot/sites/default && drush updb -y
cd /var/www/project/labiomed/docroot/sites/default && drush cr -y
cd /var/www/project/labiomed/docroot/sites/default && drush cim -y
cd /var/www/project/labiomed/docroot/sites/default && drush cr -y